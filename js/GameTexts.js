...
const GameTexts = {
    ...
    gameOver: {
        ...
        donationText: "Ця гра створена, щоб популяризувати наш збір на Беспілотну платфорому і РЕБ до неї для \nББС ʼНебесна Мараʼ 43ї ОМБр.\n" +
        "Прошу тебе задонатити і поділитись грою з друзями.\n" +
        "<b>Всі донати з гри подвоїть компанія AltexSoft!</b>\n" +
        "Дякую за підтримку!",
